 ...
 *
 */
public class Req04I1AFormatter extends SubParser<CompetitorPriceItemC, CompetitorPriceC> {
	...
	@Override
	public void preFormat(CompetitorPriceC master, CompetitorPriceItemC entity) {
		entity.setCompetitorPriceC(master.getName());
	}
